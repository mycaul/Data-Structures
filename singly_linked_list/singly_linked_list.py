...
class LinkedList:
  ...
  def remove_tail(self):
    ...
    # otherwise, the linked list has more than one value
    else:
      ...
      # init another reference to keep track of where we are in the linked list as we're iterating
      current = self.head
...
# ll.next_node.next.set_next(Node(22))
# ll.next_node.next_node.set_next(Node(3))